...
class entity_order extends entity
{
    ...
    public function _map_schema( )
    {
        $order_schema = array(
            ...
            "status" => array( "status" ),
            "meta" => array( "itemnum", "acttime", "is_delivery", "acttime", "refer_id", "refer_url", "ip", "is_tax", "is_protect", "cost_protect", "cur_rate", "score_u", "score_g", "score_e", "advance", "discount", "use_pmt", "total_amount", "final_amount", "pmt_amount", "payed", "markstar", "memo", "print_status", "mark_text", "disabled", "use_registerinfo", "mark_type", "extend", "is_has_remote_pdts", "cur_name" ),
            ...
            case "order_item" :
                ...
                foreach ( $v as $order_k => $order_v )
                {
                    foreach ( $order_v as $ok => $ov )
                    {
                        ...
                        else if ( $ok == "product_name" || $ok == "product_price" || $ok == "product_status" )
                        {
    ...
    public function _getOrder( $arr, $map_arr )
    {
        $array['order'] = array( );
    ...
    public function _getCurrency( $arr )
    {
        foreach ( $arr as $k => $v )
        {
            if ( $k == "currency" )
    ...
    public function _getLastmodified( $arr )
    {
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getCost( $arr, $map_arr )
    {
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getOrderMeta( $arr, $map_arr )
    {
        $meta_arr['meta'] = array( );
        if ( is_array( $arr ) )
        {
    ...
    public function _getOrderId( $arr, $map_arr )
    {
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getOrderMemberId( $arr, $map_arr )
    {
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getOrderCreatetime( $arr, $map_arr )
    {
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getOrderStatus( $arr, $map_arr )
    {
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getConsignee( $arr, $map_arr )
    {
        $consignee = array( );
        foreach ( $arr as $k => $v )
        {
    ...
    public function _getOrderItems( $arr, $map_arr )
    {
        $order_item = array( );
    ...
    public function _getShipmentWant( $arr, $map_arr )
    {
    ...
    public function _getPaymentWant( $arr, $map_arr )
    {
    ...
    public function _getPayment( $arr, $map_arr )
    {
    ...
    public function _getShipment( $arr, $map_arr )
    {
