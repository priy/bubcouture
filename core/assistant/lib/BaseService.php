...
class BaseService
{
    ...
    public function init( &$server )
    {
        ...
        $server->wsdl->addComplexType( "StringArray", "complexType", "array", "", "SOAP-ENC:Array", array( ), array(
            array( "ref" => "SOAP-ENC:arrayType", "wsdl:arrayType" => "xsd:string[]" )
        ), "" );
        $server->wsdl->addComplexType( "IntegerArray", "complexType", "array", "", "SOAP-ENC:Array", array( ), array(
            array( "ref" => "SOAP-ENC:arrayType", "wsdl:arrayType" => "xsd:int[]" )
        ), "" );
        $server->wsdl->addComplexType( "SyncItem", "complexType", "struct", "all", "", array(
        ...
        $server->wsdl->addComplexType( "SyncItemArray", "complexType", "array", "", "SOAP-ENC:Array", array( ), array(
            array( "ref" => "SOAP-ENC:arrayType", "wsdl:arrayType" => "tns:SyncItem[]" )
        ), "tns:SyncItem" );
        $server->wsdl->addComplexType( "SyncPack", "complexType", "struct", "all", "", array(
            "items" => array( "name" => "items", "type" => "tns:SyncItemArray" )
        ) );
    }

    public function baseErrorHandler( $errno, $errstr, $errfile, $errline )
    {
        switch ( $errno )
        {
        case E_ERROR :
