...
class goods_1Validator extends BaseValidator
{
    ...
    public function goods_1Validator( $sys )
    {
        parent::basevalidator( $sys );
    }

    public function genGoodsBn( &$row )
    {
    ...
    public function validateUpdateBefore( &$row )
    {
        ...
        if ( isset( $row['score_setting'], $row['score_setting'] ) )
        {
            $row['score_setting'] = "number";
        }
        if ( isset( $row['goods_type'], $row['goods_type'] ) )
        {
            $row['goods_type'] = "normal";
        }
