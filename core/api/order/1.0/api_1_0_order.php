...
class api_1_0_order extends shop_api_object
{
    ...
    public function set_order_status( $data, $innerloader = FALSE )
    {
        if ( !$data['status'] )
        {
    ...
    public function set_pay_status( $data, $innerloader = FALSE )
    {
    ...
    public function set_ship_status( $data, $innerloader = FALSE )
    {
    ...
    public function search_aftermarket_list( $data )
    {
    ...
    public function set_aftermarket_status( $data )
    {
    ...
    public function set_aftermarket_status_c( $data )
    {
        foreach ( $data as $k => $v )
        {
    ...
    public function set_order_status_center( $data )
    {
        ...
        if ( isset( $data['pay_status'] ) && 0 <= intval( $data['pay_status'] ) )
        {
        ...
        if ( isset( $data['ship_status'] ) && 0 <= intval( $data['ship_status'] ) )
        {
    ...
    public function search_order_detail( $data )
    {
        ...
        foreach ( $result['data_info']['product_info'] as $key => $value )
        {
            foreach ( $value['items'] as $p => $t )
            {
                ...
                unset( $Var_2688['item_id'] );
                unset( $Var_2808['product_price'] );
    ...
    public function search_order_list( $data )
    {
        if ( $data['status'] )
        {
        ...
        if ( isset( $data['page_no'], $data['page_size'] ) )
        {
            if ( $data['page_no'] === 1 )
            {
                $p_min = 0;
    ...
    public function get_order_log( $data )
    {
        if ( $data['order_id'] )
        {
    ...
    public function get_order_message( $data )
    {
    ...
    public function set_order_message( $data )
    {
        $aData = array(
            "for_id" => $data['for_id'],
    ...
    public function get_order_promotion( $data )
    {
        if ( $data['order_id'] )
        {
    ...
    public function update_order_remark( $data )
    {
        $adata = array(
    ...
    public function update_order( $data )
    {
        ...
        unset( $data['status'] );
        if ( ( $row = $this->db->selectrow( "SELECT * FROM sdb_orders WHERE order_id=".$data['order_id'] ) ) && $row['pay_status'] != 0 && $row['ship_status'] != 0 && $row['status'] != "active" )
        {
        ...
        {
            $this->db->exec( "DELETE FROM sdb_order_items WHERE order_id=".$data['order_id'] );
        }
        foreach ( json_decode( $data['orders']['order'], TRUE ) as $key => $value )
        {
    ...
    public function get_shippings( $data )
    {
    ...
    public function set_payment_status( $data, $innerloader = FALSE )
    {
    ...
    public function add_member_advance( $data, $innerloader = FALSE )
    {
