...
class api_b2c_2_0_delivery extends shop_api_object
{
    ...
    public function notify_delivery( $input_data )
    {
    ...
    public function _add_ship_bill( $order_info, $delivery_item, $type = "delivery" )
    {
    ...
    public function _delivery( $order_info, $delivery_item )
    {
        $dealer_orderid = $order_info['order_id'];
    ...
    public function _return( $order_info, $delivery_item )
    {
        $dealer_orderid = $order_info['order_id'];
        $supplier_id = $order_info['supplier_id'];
    ...
    public function _add_order_log( $supplier_id, $dealer_order_id, $delivery_id )
    {
        $message_part1 = "";
        $message = "";
        $behavior = "";
    ...
    public function _add_log( $supplier_id, $order_id, $message, $behavior )
    {
