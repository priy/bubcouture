...
class ctl_tmpimage extends objectPage
{
    ...
    public $object = "resources/tmpimage";
    ...
    public function _detail( )
    {
        return array(
            "show_detail" => array(
                "label" => __( "模板文件信息" ),
                "tpl" => "system/template/tplresource.html"
            )
        );
    }
    ...
    public function index( )
    {
        ...
        else
        {
            ...
            $this->pagedata['lastpath'] = substr( $this->pagedata['path'], 0, 0 - $length );
        }
    ...
    public function show_detail( $sName )
    {
        $this->_index( );
        $oImg =& $this->system->loadModel( "resources/tmpimage" );
    ...
    public function recoverSource( $sName, $dest, $tmpid )
    {
        $this->_index( );
        $this->system->setConf( "system.theme_last_modified", time( ) );
