...
class ctl_magicvars extends objectPage
{
    ...
    public $object = "system/magicvars";
    public $finder_action_tpl = "system/magicvars/finder_action.html";
    public $finder_default_cols = "_cmd,var_name,var_title,var_value";
    public $filterUnable = TRUE;

    public function ctl_magicvars( )
    {
        parent::objectpage( );
    ...
    public function save( )
    {
        ...
        $GLOBALS['_POST']['var_type'] = "custom";
        if ( isset( $_POST['is_editing'] ) )
        {
            $this->end( $magicvars->update( $_POST, array(
                "var_name" => $_POST['var_name']
            ), $message ), $message ? $message : __( "修改成功" ), "index.php?ctl=system/magicvars&act=index" );
        }
        else
        {
