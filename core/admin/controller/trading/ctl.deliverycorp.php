...
class ctl_deliverycorp extends objectPage
{
    ...
    public $object = "trading/deliverycorp";
    public $finder_action_tpl = "delivery/corp_finder_action.html";
    ...
    public function _detail( )
    {
        return array(
            "show_detail" => array(
                "label" => __( "物流公司" ),
                "tpl" => "delivery/corp_edit.html"
            )
        );
    }

    public function show_detail( $nCorpId )
    {
