...
class ctl_delivery extends objectPage
{
    ...
    public $object = "trading/delivery";
    public $finder_action_tpl = "delivery/finder_action.html";
    public $finder_default_cols = "_cmd,dt_name,dt_status,protect,has_cod,ordernum";
    ...
    public function newTypeStep( )
    {
        ...
        $this->pagedata['config'] = array( "firstunit" => "1000", "continueunit" => "1000" );
        $this->page( "delivery/dtype_edit.html" );
    }

    public function showEdit( $nDTid )
    {
        if ( !$nDTid )
        {
            $this->newTypeStep( );
    ...
    public function showRateHelp( )
    {
        $this->page( "delivery/help_rate.html" );
    }

    public function showMantesHelp( )
    {
        $this->page( "delivery/help_mantes.html" );
    }

    public function dlAreaList( )
    {
        $this->path[] = array(
            "text" => __( "配送地区" )
        );
    ...
    public function detailDlCorp( $nCorpId )
    {
        $this->path[] = array(
            "text" => __( "物流公司编辑" )
        );
    ...
    public function _getAreaType( )
    {
        return array(
            ...
            9 => array(
                "CNQY",
                __( "全一快递" ),
                "http://www.apex100.com/"
            ),
            10 => array(
                "CNHT",
                __( "汇通速递" ),
                "http://www.htky365.com/"
            ),
            11 => array(
                "CNMH",
                __( "民航快递" ),
    ...
    public function _getAreaTypeRel( )
    {
        return array(
            "CNEMS" => __( "中国邮政EMS" ),
            "CNST" => __( "申通快递" ),
    ...
    {
        if ( $key == "ordernum" && intval( $_POST['data'] ) <= 0 )
        {
            echo "排序必须为正整数";
            exit( );
        }
