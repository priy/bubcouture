...
class ctl_category extends objectPage
{
    ...
    public $object = "goods/productCat";
    ...
    public function addView( $catid )
    {
        $this->pagedata['params'] = array(
            "cat_id" => $catid
        );
        $this->pagedata['item'] = array(
            "label" => "New View ".mydate( "H:i:s" )
        );
        $this->display( "product/category/view_row.html" );
    }

    public function saveView( $catid )
    {
