...
class ctl_content extends adminPage
{
    ...
    public function indexOfgoodsCat( $nId )
    {
        $sitemap = $this->system->loadModel( "content/sitemap" );
    ...
    public function urllinkSave( )
    {
        if ( $_POST['ident'] && $_POST['url_address'] )
        {
            $sitemap =& $this->system->loadModel( "content/sitemap" );
            $setTitle = $sitemap->setAction( $_POST['ident'], array(
                "action" => $_POST['url_address'],
                "item_id" => $_POST['url_set']
            ) );
    ...
    public function definedDetailPage( $id )
    {
        $this->path[] = array(
            "text" => __( "页面内容编辑" )
        );
    ...
    public function delType( $sTypeId )
    {
        $oArticle =& $this->system->loadModel( "content/article" );
    ...
    public function savecustompage( )
    {
