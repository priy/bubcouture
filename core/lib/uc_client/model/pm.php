...
class pmmodel
{
    ...
    public function get_pm_by_pmid( $uid, $pmid )
    {
        $arr = array( );
    ...
    public function get_pmnode_by_pmid( $uid, $pmid, $type = 0 )
    {
        $arr = array( );
        if ( $type == 1 )
        {
    ...
    public function set_pm_status( $uid, $pmid )
    {
    ...
    public function get_pm_num( )
    {
    }

    public function get_num( $uid, $folder, $filter = "" )
    {
        switch ( $folder )
        {
        case "newbox" :
    ...
    public function get_pm_list( $uid, $pmnum, $folder, $filter, $start, $ppp = 10 )
    {
        $ppp = $ppp ? $ppp : 10;
        switch ( $folder )
        {
        ...
        {
            $daterange = 5;
            if ( $today <= $data['dateline'] )
            {
                $daterange = 1;
            }
            else if ( $today - 86400 <= $data['dateline'] )
            {
                $daterange = 2;
            }
            else if ( $today - 172800 <= $data['dateline'] )
            {
                $daterange = 3;
            }
            else if ( $today - 604800 <= $data['dateline'] )
            {
                $daterange = 4;
            }
    ...
    public function sendpm( $subject, $message, $msgfrom, $msgto, $related = 0 )
    {
