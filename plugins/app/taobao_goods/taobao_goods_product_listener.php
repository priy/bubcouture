...
class taobao_goods_product_listener extends pageFactory
{
    ...
    public function taobao_goods_product_listener( )
    {
        parent::pagefactory( );
    ...
    public function toAdd( $args, $p2 )
    {
        ...
        $source_data['location_state'] = $data['taobao']['state'];
        $source_data['location_city'] = $data['taobao']['city'];
        ...
        if ( $_POST['taobao']['auction_point'] )
        {
            $send_params['auction_point'] = $_POST['taobao']['auction_point'];
        }
        $outer_content = array(
            "content" => $send_params,
            "images" => $images,
