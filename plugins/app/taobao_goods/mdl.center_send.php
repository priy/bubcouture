...
class mdl_center_send extends mdl_apiclient{
    ...
    function open_servies(){
        return $this->returncenterMess($this->native_svc("service.open_services",array('certificate_id'=>$this->cert_id,'services'=>'taobao_goods_synchronize'))); 
    }
    ...
    function app_valid(){
         return $this->returncenterMess($this->native_svc("service.valid",array('certificate_id'=>$this->cert_id,'version'=>'1.0','service_id'=>'taobao_goods_synchronize','app_id'=>'shopex_esb')));
    }
