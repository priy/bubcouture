...
class passport_phpwind extends modelFactory
{
    ...
    public $passport_name = "PhpWind论坛V6.3.2";
    ...
    public function login( $userId, $rurl )
    {
        ...
        {
            return $shop_loginapi_url."?action=login&userdb=".rawurlencode( $userdb_encode )."&forward=".rawurlencode( $forward )."&verify=".$verify;
        }
        else
        {
