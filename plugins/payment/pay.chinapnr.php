...
class pay_chinapnr extends paymentPlugin
{
    ...
    public $name = "天天付在线支付（汇付天下）";
    public $logo = "CHINAPNR";
    public $version = 20070902;
    public $charset = "gb2312";
    public $submitUrl = "https://payment.chinapnr.com/pay/TransGet";
    ...
    public $desc = "汇付天下（ www.chinapnr.com）是中国最具创新支付公司，注册资本过亿。现申请“天天付”网上支付平台可获年服务费全免，手续费 0.8％，并免费享用“ T+1”结算，“单边账应急处理”等可选特色增值服务优惠！<br>申请方式:<br>电话:021-64486999-8862/13817018164 阮先生<br>邮箱:<a href='mailto:robin.ruan@chinapnr.com'>robin.ruan@chinapnr.com</a>";
    public $orderby = 15;
    ...
    public function toSubmit( $payment )
    {
        ...
        $return['TransType'] = "P";
        $return['GateId'] = "";
        $return['MerPriv'] = $payment['M_OrderNO'];
    ...
    {
        return array(
            "member_id" => array( "label" => "客户号", "type" => "string", "helpMsg" => "此处填写您的支付帐号、客户号或客户id等，此帐号在支付服务提供商处取得；" ),
            "PrivateKey" => array( "label" => "私钥", "type" => "string", "helpMsg" => "证书拆分过程中输入的保存私钥 “口令”" ),
            "key1" => array( "label" => "私钥文件1", "type" => "file", "helpMsg" => "此处上传支付网关给你的“MerPrK你的商户号.key”文件；" ),
            "key2" => array( "label" => "私钥文件2", "type" => "file", "helpMsg" => "此处上传支付网关给你的“PgPubk.key”文件；" )
        );
    }
