...
class pay_tenpaytrad extends paymentPlugin
{
    ...
    public $logo = "TENPAYTRAD";
    public $version = 20080618;
    public $charset = "gb2312";
    public $applyUrl = "https://www.tenpay.com/mchhelper/mch_register_c2c.shtml";
    public $submitUrl = "https://www.tenpay.com/cgi-bin/med/show_opentrans.cgi";
    ...
    public $intro = "财付通是腾讯公司于2005年9月正式推出专业在线支付平台，致力于为互联网用户和企业提供安全、便捷、专业的在线支付服务。<br>财付通构建全新的综合支付平台，业务覆盖B2B、B2C和C2C各领域，提供卓越的网上支付及清算服务。<br>财付通先后荣膺2006年电子支付平台十佳奖、2006年最佳便捷支付奖、2006年中国电子支付最具增长潜力平台奖和2007年最具竞争力电子支付企业奖等奖项，并于2007年首创获得“国家电子商务专项基金”资金支持。<br><br><font color=\"red\">本接口需点击【立即申请财付通担保账户】链接进行在线签约和付费后方可使用。</font>";
    ...
    public function toSubmit( $payment )
    {
        ...
        $return['mch_price'] = number_format( $payment['M_Amount'], 2, ".", "" ) * 100;
    ...
    public function callback( $in, &$paymentId, &$money, &$message, &$tradeno )
    {
        ...
        $paymentId = $attach;
        $money = $total_fee / 100;
        $param = array( "interfaceName", "interfaceVersion", "orderid", "TranSerialNo", "amount", "curType", "merID", "merAcct", "verifyJoinFlag", "JoinFlag", "UserNum", "resultType", "orderDate", "notifyDate", "tranStat", "comment", "remark1", "remark2", "signMsg" );
        foreach ( $in as $k => $val )
        {
