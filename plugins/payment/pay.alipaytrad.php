...
class pay_alipaytrad extends paymentPlugin
{
    ...
    public $name = "支付宝";
    public $logo = "ALIPAYTRAD";
    public $version = 20080523;
    public $charset = "utf8";
    ...
    public function pay_alipaytrad( &$system )
    {
    ...
    public function serverCallback( $in, &$paymentId, &$money, &$message )
    {
        exit( "reserved" );
    }
    ...
    {
        return array(
            "member_id" => array( "label" => "合作者身份(parterID)", "type" => "string" ),
            "PrivateKey" => array( "label" => "交易安全校验码(key)", "type" => "string" ),
            "real_method" => array(
                "label" => "选择接口类型",
                "type" => "select",
