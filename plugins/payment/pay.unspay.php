...
class pay_unspay extends paymentPlugin
{
    ...
    public $logo = "UNSPAY";
    public $charset = "utf8";
    public $applyUrl = "https://www.unspay.com/unspay/toCompanyRegister.do";
    public $submitUrl = "https://www.unspay.com/unspay/page/linkbank/payRequest.do";
    public $supportCurrency = array
    (
        "CNY" => "CNY"
    );
    public $intro = "银生支付成立于2006年5月30日，是一家致力于在传统互联网和移动通讯网领域大规模应用在线支付,并以此为基础提供全方位金融配套服务的电子金融服务提供商。公司将不断扩大应用范围，实现多行业、多渠道、多元化的战略目标。以成为一流的电子商务金融服务的行业引导者为公司愿景，打造成为服务于全球用户的安全可靠、快速便捷的电子支付及金融应用平台。 ";
    public $orderby = 4;
