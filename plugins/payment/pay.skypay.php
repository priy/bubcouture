...
class pay_skypay extends paymentPlugin
{
    ...
    public $name = "我付了储值卡支付(OK卡等)";
    public $logo = "SKYPAY";
    public $version = "20080901";
    public $charset = "gb2312";
    public $info = "我付了支付平台( http://www.wofule.com.cn )专注集中于为商户提供各种非银行卡资金源（联华OK卡、手机储值卡等）线上和线下的全方位支付服务，通过掌捷的非银行支付服务可以为商户提供多渠道的资金来源，同时带来更多潜在的用户群体。（中国市场上十亿多张的预付费的卡，并且每秒钟有1张预付费卡在增值。由于预付卡市场有超过90%的现存卡并不是自买自用型的,因此决定了大量的预付费卡持有者具有很强的消费欲望,并且希望能够找到更多的商户进行基于预付费卡的消费）";
    public $intro = "我付了储值卡支付网关支持了如百联OK卡等在内的国内主流预付费卡（消费储值卡）的支付，商户添加我付了储值卡支付网关后，即可让用户持消费储值卡在商户处消费。<br>中国市场上十亿多张的预付费的卡，并且每秒钟有1张预付费卡在增值。由于预付卡市场有超过90%的现存卡并不是自买自用型的，因此决定了大量的预付费卡持有者具有很强的消费欲望。<br>集成我付了储值卡支付网关后，可以为商户吸引大量的预付费卡用户群及消费资金，极大提升商户的销售收入。<br><br>网关自助接入服务：<a href='http://www.wofule.com.cn/merchant_regist' target='_blank'>立即申请我付了</a><br>客服电话：400-820-7040 ";
    public $submitUrl = "http://gateway.wofule.com.cn/gateway/paymentorder";
    ...
    public function getfields( )
    {
        return array(
            ...
            "PrivateKey" => array( "label" => "密钥", "type" => "string" )
        );
    }
