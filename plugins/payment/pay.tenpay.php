...
class pay_tenpay extends paymentPlugin
{
    ...
    public $name = "腾讯财付通[即时到账]";
    public $logo = "TENPAY";
    public $version = 20070902;
    public $charset = "gb2312";
    public $applyUrl = "http://union.tenpay.com/mch/mch_register_b2c.shtml";
    public $submitUrl = "https://www.tenpay.com/cgi-bin/v1.0/pay_gate.cgi";
    ...
    public $desc = "财付通是腾讯公司为促进中国电子商务的发展需要，满足互联网用户价值需求，针对网上交易安全而精心推出的一系列服务。";
    public $intro = "财付通是腾讯公司于2005年9月正式推出专业在线支付平台，致力于为互联网用户和企业提供安全、便捷、专业的在线支付服务。<br>财付通构建全新的综合支付平台，业务覆盖B2B、B2C和C2C各领域，提供卓越的网上支付及清算服务。<br>财付通先后荣膺2006年电子支付平台十佳奖、2006年最佳便捷支付奖、2006年中国电子支付最具增长潜力平台奖和2007年最具竞争力电子支付企业奖等奖项，并于2007年首创获得“国家电子商务专项基金”资金支持。<!--<br><br><font color=\"red\">本接口需点击以下链接(二选一)进行在线签约后方可使用。</font>-->";
    public $applyProp = array
    (
        "postmethod" => "get",
        "sp_suggestuser" => "2289480"
    );
    public $orderby = 2;
    ...
    public function toSubmit( $payment )
    {
        ...
        $payment['M_Amount'] = number_format( $payment['M_Amount'], 2, ".", "" ) * 100;
        ...
        $str = "agentid=".$agentid."&attach=".$payment['M_OrderId']."&bank_type=0&bargainor_id=".$merId."&cmdno=1&date=".$orderdate."&desc=".$desc."&fee_type=".$payment['M_Currency']."&key_index=1&return_url=".$this->callbackUrl."&sp_billno=".$sp_billno."&total_fee=".$payment['M_Amount']."&transaction_id=".$v_orderid."&ver=3&verify_relation_flag=1&key=".$ikey;
